...
class EBS_Dashboard(object):
    ...
    def set_asset_holding(self, workDir, fileName, asset_fileName_T_plus_1, Price_Date, market_factor, output = 1, mappingFile = '.\Mapping_v2.xlsx', ratingMapFile = '.\Rating_Mapping_v2.xlsx'):
    ...
    def set_derivative_charge(self,asset_workDir, fileName):
        self.asset_holding = Asset_App.update_asset_holding(self.asset_holding, self.eval_date, asset_workDir, fileName)
