...
### Kyle: please uncomment the line below to restore previous version
#if __name__ == "Config_Run_Control":
if __name__ == "__main__":  
    ...
    version = { '2018Q4_Base' : cfo.run_control(val_date   = dt.datetime(2018, 12, 31), 
                                                ...
                                                date_end   = dt.datetime(2099, 12, 31),
                                                freq       = 'A'),
